...
static const char *const yytname[] =
{
  ...
  "'>'", "NE", "LE", "GE", "EQ", "'+'", "'-'", "'*'", "'/'", "'('", "')'",
  "UMINUS", "'\\n'", "$accept", "program", "stmnt", "expr", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,    61,    60,    62,   260,   261,
     262,   263,    43,    45,    42,    47,    40,    41,   264,    10
};
# endif
...
{
     -14,     0,   -14,   -14,     4,    14,    14,   -14,    -5,    -7,
      14,   -14,   -14,    19,   -14,    14,    14,    14,    14,    -7,
     -14,   -13,   -13,   -14,   -14
};
...
{
       2,    17,    18,     3,     4,    15,    16,    17,    18,    10,
      12,    13,     0,     5,    14,    19,     6,     3,    11,     7,
...
{
       0,    14,    15,     3,     4,    12,    13,    14,    15,     5,
       5,     6,    -1,    13,    19,    10,    16,     3,     4,    19,
      15,    16,    17,    18,    -1,    -1,    -1,    13,    -1,    -1,
      16,    12,    13,    14,    15,    -1,    17
};
...
{
       0,    21,     0,     3,     4,    13,    16,    19,    22,    23,
       5,     4,    23,    23,    19,    12,    13,    14,    15,    23,
      17,    23,    23,    23,    23
};
...
#line 1229 "y.tab.c" /* yacc.c:1646  */
  ...
  case 6:
#line 31 "one.y" /* yacc.c:1646  */
    { sym[(yyvsp[-2])] = (yyvsp[0]);//$1=a=0,$1=b=1,$1=c(VARIABLE)=2(index number) 
...
#line 40 "one.y" /* yacc.c:1646  */
    { (yyval) = sym[(yyvsp[0])]; //printf("$$ = %d $1 = %d\n",$$,$1);
                                         if((yyval) == 0){flag=1; printf("Compilation Error\n");}
...
#line 1258 "y.tab.c" /* yacc.c:1646  */
  ...
  case 10:
#line 51 "one.y" /* yacc.c:1646  */
    { (yyval) = (yyvsp[-2]) - (yyvsp[0]); }
#line 1264 "y.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 52 "one.y" /* yacc.c:1646  */
    { (yyval) = (yyvsp[-2]) * (yyvsp[0]); }
#line 1270 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 53 "one.y" /* yacc.c:1646  */
    {
                                    if((yyvsp[0])==0) yyerror("divide 0");
